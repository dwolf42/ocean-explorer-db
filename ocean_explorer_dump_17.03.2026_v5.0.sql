...
CREATE TABLE IF NOT EXISTS `radar_results` (
  ...
  KEY `shipID` (`shipID`),
  CONSTRAINT `rr_fk_scan` FOREIGN KEY (`shipID`) REFERENCES `ship` (`shipID`),
  CONSTRAINT `rr_fk_sector` FOREIGN KEY (`sectorID`) REFERENCES `sector` (`sectorID`)
...
CREATE TABLE IF NOT EXISTS `sector` (
  ...
  UNIQUE KEY `unique_sector` (`position_x`,`position_y`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
CREATE TABLE IF NOT EXISTS `ship` (
  ...
  `server_ship_id` varchar(50) NOT NULL,
  `crash_position_x` int(11) DEFAULT NULL,
  `crash_position_y` int(11) DEFAULT NULL,
  `crash_position_z` int(11) DEFAULT NULL,
  PRIMARY KEY (`shipID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
CREATE TABLE IF NOT EXISTS `ship_scan_results` (
  ...
  KEY `shipID` (`shipID`),
  CONSTRAINT `ssr_fk_scan` FOREIGN KEY (`scan_resultID`) REFERENCES `scan_results` (`scan_resultID`),
  CONSTRAINT `ssr_fk_sector` FOREIGN KEY (`sectorID`) REFERENCES `sector` (`sectorID`),
  CONSTRAINT `ssr_fk_ship` FOREIGN KEY (`shipID`) REFERENCES `ship` (`shipID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
CREATE TABLE IF NOT EXISTS `submarine` (
  ...
  `surfaced` enum('Yes','No') DEFAULT 'No',
  `sunk` enum('Yes','No') DEFAULT 'No',
  `server_sub_id` varchar(50) NOT NULL,
  PRIMARY KEY (`submarineID`),
  KEY `shipID` (`shipID`),
  KEY `sink_positionID` (`sink_positionID`),
  KEY `arise_positionID` (`arise_positionID`),
  CONSTRAINT `sub_fk_arise` FOREIGN KEY (`arise_positionID`) REFERENCES `submarine_arise_position` (`arise_positionID`),
  CONSTRAINT `sub_fk_ship` FOREIGN KEY (`shipID`) REFERENCES `ship` (`shipID`),
  CONSTRAINT `sub_fk_sink` FOREIGN KEY (`sink_positionID`) REFERENCES `submarine_sink_position` (`sink_positionID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
CREATE TABLE IF NOT EXISTS `submarine_measurements` (
  ...
  KEY `sectorID` (`sectorID`),
  CONSTRAINT `sm_fk_sector` FOREIGN KEY (`sectorID`) REFERENCES `sector` (`sectorID`),
  CONSTRAINT `sm_fk_sub` FOREIGN KEY (`submarineID`) REFERENCES `submarine` (`submarineID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
